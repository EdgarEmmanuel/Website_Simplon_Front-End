...
class Controller_BP{
    ...
    public function getPageAddClientSalarie(){
        //getMatSalarie()
        $SalarieIMPL = new  \App\Dao\SalarieImpl();
    ...
    public function getPageClientNoSalarie(){
        ...
        $NoSalarieIMPL = new \App\Dao\NoSalarieImpl();
    ...
    public function verifyRespoCompte($login,$mdp){
        $IRespo = new \App\Dao\RespoCompteImpl();
        $AgenceImpl = new \App\Dao\AgenceImpl();
    ...
    public function getClientById($data){
        ...
        $moralIMPL = new \App\Dao\MoralImpl();
