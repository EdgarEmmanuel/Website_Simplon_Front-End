 ...
 * @since 1.0.0
 */
class Danfe_Author_Widget extends WP_Widget{
     public function __construct(){
          parent::__construct(
               'danfe-author-widget',
               __( 'CT Author', 'danfe' ),
               array( 'description' => __( 'Place anywhere in the Widget area.', 'danfe' ) )
          );
     }   
     ...
     public function form($instance ){
          ?>
          <p>
              <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e( 'Author or Ads Title', 'danfe' ); ?></label><br />
            ...
            <p>
                <label for="<?php echo $this->get_field_id('description'); ?>"><?php _e( 'Author or Ads Description', 'danfe' ); ?></label><br />
              ...
              <p>
                 ...
                 <input type="text" class="widefat custom_media_url" name="<?php echo $this->get_field_name('image_uri'); ?>" id="<?php echo $this->get_field_id('image_uri'); ?>" value="<?php 
                  ...
                  ?>">
                 <input type="button" class="button button-primary custom_media_button" id="custom_media_button" name="<?php echo $this->get_field_name('image_uri'); ?>" value="<?php esc_attr_e('Upload Image','danfe')?>" />
             </p>
             <p>
                <label for="<?php echo esc_attr( $this->get_field_id('facebook') ); ?>"><?php _e( 'Facebook', 'danfe' ); ?></label><br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('twitter') ); ?>"><?php _e( 'Twitter', 'danfe' ); ?></label><br />
         ...
         <p>
                <label for="<?php echo esc_attr( $this->get_field_id('googleplus') ); ?>"><?php _e( 'Google Plus', 'danfe' ); ?></label><br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('instagram') ); ?>"><?php _e( 'Instagram', 'danfe' ); ?></label><br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('linkedin') ); ?>"><?php _e( 'Linkedin', 'danfe' ); ?></label><br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('youtube') ); ?>"><?php _e( 'Youtube', 'danfe' ); ?></label><br />
...
add_action( 'widgets_init', 'danfe_author_widget' ); 
function danfe_author_widget(){     
    register_widget( 'Danfe_Author_Widget' );
}
