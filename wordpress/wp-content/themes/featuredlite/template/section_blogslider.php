...
<input type="hidden" id="slidecnt" value="<?php echo get_theme_mod('post_count','5')?>"/>
<section id="news" class="multi-slider-area">
    <?php if(get_theme_mod( 'blog_head_')!=''){?>
    <h2 class="head-text wow thunk-fadeInLeft" data-wow-duration="1s"><?php echo get_theme_mod( 'blog_head_'); ?></h2>
    <?php } else { ?>
    ...
    <h3 class="subhead-text wow thunk-fadeInLeft" data-wow-duration="1s"><?php echo get_theme_mod( 'blog_desc_'); ?></h3>
    <?php } else { ?>
